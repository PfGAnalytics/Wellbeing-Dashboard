...
async function renderMapPopup(d, e, type) {
    ...
    pop_up_map.style.backgroundColor = "#F2F2F2";
    ...
    if (window.innerWidth < 1200) {
      ...
      closeBtn.style.marginLeft = pop_up_map.clientWidth - 30 + "px";     // Position it 30 pixels from end of box
      ...
      pop_up_map.appendChild(loading);     // insert loading image into document
      loading.style.marginLeft = (pop_up_map.clientWidth - loading.clientWidth) / 2 + "px";      // Position loading image in centre
      loading.style.marginTop = "100px";     // Add 100px top margin
      
      const mapContainer = document.createElement("div");
      mapContainer.id = "popup-map-container";
      mapContainer.style.width = "100%";
      mapContainer.style.height = "600px"; // Adjust as needed
