    ...
    "Thriving Children": {
       ...
       indicators: {
         ...
         "Small for gestational age": {
            ...
            base_year: "2019",
            ci: 2.75,
            latest_update: "13-04-2026",
            next_update: "March 2027",
            map_commentary: "",
            data: {
               NI: "INDSFGANI",
               AA: "",
    ...
    "Cleaner Environment": {
       ...
       indicators: {
         ...
         "Air pollution": {
            ...
            AOS: true,
            ci: 1,
            latest_update: "16-06-2026",
            next_update: "May 2027",
            map_commentary: "",
            data: {
               NI: "INDAIRPOLNI",
               AA: "",
    ...
    "Equal Society": {
       ...
       indicators: {
         ...
         "Income deprivation": {
            ...
            telling: {
               improved: "This commentary is a placeholder.",
               no_change: "Over the last ten years, the proportion of individuals in absolute poverty (BHC) generally decreased slowly from a high of 21% in 2013/14 to a low of 12% in 2020/21 before increasing to the current position of 15% in 2023/24. Changes are being made to the way poverty and income statistics are produced in Northern Ireland to improve the quality, coherence and completeness of income-based poverty statistics. Consequently, the figures for this indicator are under review. The latest information and revised statistics are available <a href = 'https://www.communities-ni.gov.uk/topics/family-resources-survey-and-poverty-analysis' target = '_blank'>from this link. </a>",
               worsened: "This commentary is a placeholder.",
               insufficient: ""
            }
         },
         "Income inequality": {
            ...
            telling: {
               improved: "This commentary is a placeholder.",
               no_change: "Over the last ten years, the proportion of individuals in relative poverty (BHC) has fluctuated between a high of 22% in 2014/15 and lows of 16% in 2017/18 and 2021/22. Changes are being made to the way poverty and income statistics are produced in Northern Ireland to improve the quality, coherence and completeness of income-based poverty statistics. Consequently, the figures for this indicator are under review. The latest information and revised statistics are available <a href = 'https://www.communities-ni.gov.uk/topics/family-resources-survey-and-poverty-analysis' target = '_blank'>from this link. </a>",
               worsened: "This commentary is a placeholder.",
               insufficient: ""
            }
         },
    ...
    "Brighter Futures": {
       ...
       indicators: {
         ...
         "Life satisfaction": {
            ...
            base_year: "2021/22",
            ci: 0.11,
            latest_update: "02-02-2026",
            next_update: "Autumn 2026",
            map_commentary: "",
            ni_line: true,
            data: {
               NI: "",
    ...
    "Stronger Economy": {
       ...
       indicators: {
         ...
         "Northern Ireland Composite Economic Index": {
            ...
            improvement: "increase",
            telling: {
               improved: "Economic activity has increased gradually in recent years. Economic activity post-pandemic has recovered substantially and the latest 2026 data is now at a series high. Over the second quarter of 2026, economic output in Northern Ireland increased by 1.0%, mainly driven by increased activity in the Production and Services sectors. Quarterly figures are available <a href = 'https://www.nisra.gov.uk/statistics/economic-output-statistics/ni-composite-economic-index' target = '_blank'>from this link. </a>",
               no_change: "This commentary is a placeholder.",
               worsened: "This commentary is a placeholder.",
               insufficient: ""
            }
